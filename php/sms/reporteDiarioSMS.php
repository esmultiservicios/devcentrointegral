...
$registro = "SELECT CONCAT(c.nombre,' ',c.apellido) AS 'colaborador', (CASE WHEN s.paciente = 'N' THEN 'Nuevo' ELSE 'Subsiguiente' END) AS 'Paciente',
...
".$where."
GROUP BY c.colaborador_id, s.paciente";
