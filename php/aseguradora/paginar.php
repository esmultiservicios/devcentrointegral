...
while($registro2 = $result->fetch_assoc()){  
	$tabla = $tabla.'<tr>
			...
			<td>'.$registro2['rtn'].'</td>		
			<td>
			  <a style="text-decoration:none;" title = "Editar Usuario" href="javascript:editarRegistro('.$registro2['aseguradora_id'].');void(0);" class="fas fa-edit fa-lg"></a>	  			  
			  <a style="text-decoration:none;" href="javascript:modal_eliminar('.$registro2['aseguradora_id'].');void(0);" class="fas fa-trash fa-lg"></a>
			</td>
			</tr>';	
			$i++;				
}
