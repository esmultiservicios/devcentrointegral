      ...
      <div class="modal-content">
        ...
        <div class="modal-body">		
			<form class="FormularioAjax" id="formularioEmpresa" data-async data-target="#rating-modal" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">	
				<input type="hidden" name="fact_empresas_id" id="fact_empresas_id" class="form-control">

				<div class="form-row">
					<div class="col-md-12 mb-3">
					  <label for="aseguradora">Empresa <span class="priority">*<span/></label>
					  <div class="input-group mb-3">
						  <input type="text" name="empresa" id="empresa" class="form-control" placeholder="Nombre de la Empresa" maxlength="150" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required="required">
				...
				<div class="form-row">				
					<div class="col-md-12 mb-3">
					  ...
					  <div class="input-group mb-3">
						  <input type="text" name="rtn_empresa" id="rtn_empresa" class="form-control" placeholder="RTN Empresa" maxlength="14" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required="required">
						  <div class="input-group-append">				
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Configurar Empresas</li>
	</ol>
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_re_empresas.php"; 		
