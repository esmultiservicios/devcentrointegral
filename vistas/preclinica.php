...
$_SESSION['menu'] = "Confirmacion de Cita";
...
$comentario = mb_convert_case("Ingreso al Modulo de Confirmación de Cita", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Confirmación de Cita :: <?php echo SERVEREMPRESA;?></title>
